...
<script type="text/javascript">
    ...
    function Buscar(empresa, categoria, prioridade, status, titulo, abertura, fechamento, pg) {
        document.getElementById('pgatual').value = '';
        document.getElementById('pgatual').value = parseInt(pg)+1;
        var url = 'chamados/chamados/listadados.php?consulta=sim&pg=' + pg + '&empresa=' + empresa + '&categoria=' + categoria + '&prioridade=' + prioridade + '&status=' + status + '&titulo=' + titulo + '&abertura=' + abertura + '&fechamento=' + fechamento;
