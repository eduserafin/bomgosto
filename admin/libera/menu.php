...
<div class="row">
    ...
    <div class="col-md-4 table-responsive" id="rssmenu"></div>
</div>
        ...
        if (cd_smenu == 0) {
            ...
            if (texto == '') {
                Swal.fire({
                    icon: 'warning',
                    title: 'Oops...',
                    text: 'Selecione um usuario para adicionar!'
                });
            } else {
        ...
        if (cd_smenu == 0) {
            ...
            if (texto == "") {
                Swal.fire({
                    icon: 'warning',
                    title: 'Oops...',
                    text: 'Selecione um usuario para excluir!'
                });
            } else {
