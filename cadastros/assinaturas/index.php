...
<script type="text/javascript">
    ...
    function Buscar(empresa, status, datai, dataf, pg) {
        document.getElementById('pgatual').value = '';
        document.getElementById('pgatual').value = parseInt(pg)+1;
        var url = 'cadastros/assinaturas/listadados.php?consulta=sim&pg=' + pg + '&empresa=' + empresa + '&status=' + status + '&datai=' + datai + '&dataf=' + dataf;
