<body onLoad="document.getElementById('txtnome').focus();">
    <input type="hidden" name="cd_plano" id="cd_plano" value="">
...
<script type="text/javascript">
    ...
    function executafuncao(id){
        ...
        if (id=='new'){
            ...
            document.getElementById('cd_plano').value = "";
            ...
            var codigo = document.getElementById('cd_plano').value;
            ...
            if (nome == 0) {
                ...
                window.open('parametros/planos/acao.php?Tipo=' + Tipo + '&codigo=' + codigo + '&nome=' + nome + '&status=' + status, "acao");
            }
            ...
            if(codigo==''){  
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.open("parametros/planos/acao.php?Tipo=E&codigo="+codigo, "acao");
