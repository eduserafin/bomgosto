                        ...
                        <table width="100%" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    string_agg(d.ds_arquivo, '|') AS anexos, d.nr_seq_usercadastro, d.ds_local
                                            FROM colab_doctos d INNER JOIN doctos_colab c ON d.nr_seq_tipo_documento = c.nr_sequencial
                                            WHERE d.nr_seq_colab = $nr_clifor
                                            GROUP BY d.nr_sequencial, c.ds_docto, d.ds_descricao, d.dt_cadastro, d.nr_seq_usercadastro, d.ds_local
