...
function getMailConfigs($type){
    ...
    $mailConfig['default']['username'] = 'ginfo@i9ss.com.br'; // Usu�rio do servidor SMTP (endere�o de email)
    $mailConfig['default']['address'] = 'ginfo@i9ss.com.br'; // Usu�rio do servidor SMTP (endere�o de email)
    $mailConfig['default']['name'] = 'GINFO'; // Usu�rio do servidor SMTP (endere�o de email)
